...
, 			{
				"box" : 				{
					...
					"text" : ";\rmax preempt 1;\rmax seteventinterval 5;\rmax setpollthrottle 2000;\rmax setqueuethrottle 20;\rmax setsysqelemthrottle 3000;\rmax overdrive 1;\rmax refreshrate 10;\rmax interval 5;\rmax setslop 20;\rdsp takeover 1;\r"
				}
...
, 			{
				"box" : 				{
					...
					"restore" : 					{
						"_transport_bpm" : [ 28.552142191836499 ]
					}
,
...
, 			{
				"box" : 				{
					"active" : 					{
						...
						"_preset_select2::scripting_ui_patcher::u087029355" : 0,
...
, 			{
				"box" : 				{
					...
					"fontface" : 1,
					"id" : "obj-25",
					"items" : [ "None", ",", "BlackHole 16ch", ",", "External Headphones", ",", "MacBook Pro Speakers" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 			{
				"box" : 				{
					...
					"fontface" : 1,
					"id" : "obj-36",
					"items" : [ "None", ",", "BlackHole 16ch", ",", "MacBook Pro Microphone" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
