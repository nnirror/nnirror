...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1404.228597005208485, 74.848217725753784, 54.0, 22.0 ],
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"text" : ";\rmax preempt 1;\rmax seteventinterval 1;\rmax setpollthrottle 2000;\rmax setqueuethrottle 20;\rmax setsysqelemthrottle 1500;\rmax overdrive 1;\rmax refreshrate 10;\rmax interval 1;\rmax setslop 1;\rdsp takeover 0;\r"
				}
...
, 			{
				"box" : 				{
					...
					"restore" : 					{
						"_transport_bpm" : [ 112.662969974280045 ],
						"global_randomization_metro" : [ 1 ],
						"global_randomize_every" : [ 1.0 ],
						"global_shape_mode" : [ 0.0 ],
						"pattr_randomize_gates" : [ 1, 1, 1, 1, 1, 1, 0 ],
						"randomization_intensity" : [ 80.157480314960637 ],
						"randomization_percentage" : [ 84.834645669291334 ]
					}
,
...
, 			{
				"box" : 				{
					"active" : 					{
						...
						"_preset_select2::scripting_ui_patcher::u619149296" : 0,
